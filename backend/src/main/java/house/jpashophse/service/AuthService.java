...
import house.jpashophse.domain.RefreshToken;
import house.jpashophse.dto.auth.MemberRequestDto;
import house.jpashophse.dto.auth.MemberResponseDto;
import house.jpashophse.dto.auth.TokenDto;
import house.jpashophse.dto.auth.TokenRequestDto;
import house.jpashophse.dto.request.member.CreateMemberRequest;
import house.jpashophse.jwt.TokenProvider;
import house.jpashophse.repository.MemberRepository;
import house.jpashophse.repository.RefreshTokenRepository;
...
public class AuthService {
    ...
    public TokenDto reissue(String cookieRefreshToken) {
        ...
        if (!refreshToken.getValue().equals(cookieRefreshToken)) {
            ...
            throw new RuntimeException("Refresh 토큰의 유저 정보가 일치하지 않습니다.");
        }
    ...
    public void logout(String cookieRefreshToken) {
        ...
        // 5. Delete refresh token in the repository
